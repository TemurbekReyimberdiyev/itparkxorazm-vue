      ...
      <div class="grid lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1 space-y-6">
          <div
            ...
            :key="index"
            class="flex items-start gap-4 p-6 bg-gray-50 rounded-lg shadow"
          >
            ...
            <div>
              ...
              <p
                v-for="(line, idx) in info.details"
                :key="idx"
        ...
        <div class="lg:col-span-2">
          <div class="p-8 bg-white rounded-2xl shadow-lg">
            <h3 class="text-xl font-semibold text-[#1F2937] mb-6">
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
              <div class="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    class="w-full px-4 py-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#7dba28]"
                  />
                </div>
                <div>
              ...
              <button
                type="submit"
                class="w-full bg-[#7dba28] text-white font-semibold py-3 rounded hover:bg-[#6aa822] transition"
              >
                Xabar yuborish
              </button>
            </form>
